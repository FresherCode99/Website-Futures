document.addEventListener("DOMContentLoaded", function(e) {
    ...
    let t = document.querySelector(".datatables-customers"), o = $(".select2"), r;
    o.length && (r = o).wrap('<div class="position-relative"></div>').select2({
    ...
    t && new DataTable(t,{
        ...
        columnDefs: [{
            ...
            targets: 6,
            render: function(e, t, o, r) {
                return '<span class="fw-medium text-heading">' + o.total_spent + "</span>"
            }
        }],
        select: {
            style: "multi",
        ...
        responsive: {
            details: {
                ...
                renderer: function(e, t, o) {
                    var r, n, s, o = o.map(function(e) {
                        return "" !== e.title ? `<tr data-dt-row="${e.rowIndex}" data-dt-column="${e.columnIndex}">
                      <td>${e.title}:</td>
                      <td>${e.data}</td>
                    </tr>` : ""
                    }).join("");
                    return !!o && ((r = document.createElement("div")).classList.add("table-responsive"),
