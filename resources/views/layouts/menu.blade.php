...
<span class="text-primary">
  ...
  <svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <span class="app-brand-text demo menu-text fw-bold ms-2">W-Rabbit</span>
    </a>
  ...
  <div class="menu-inner-shadow"></div>
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item {{Request::is('user/*') ? 'active open' : '' }}">
        ...
        <ul class="menu-sub">
          <li class="menu-item {{Request::is('user/my-profile') ? 'active' : '' }}">
            <a href="{{route('my-profile')}}" class="menu-link">
              <div data-i18n="Profile">Profile</div>
            </a>
          </li>
          <li class="menu-item {{Request::is('user/my-team') ? 'active' : '' }}">
            <a href="{{route('my-team')}}" class="menu-link">
              <div data-i18n="Team">Team</div>
            </a>
          </li>
          <li class="menu-item {{Request::is('user/my-projects') ? 'active' : '' }}">
            <a href="#" class="menu-link">
              <div data-i18n="Projects">Projects</div>
            </a>
          </li>
          <li class="menu-item {{Request::is('user/my-connections') ? 'active' : '' }}">
