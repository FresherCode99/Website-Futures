document.addEventListener("DOMContentLoaded", function(e) {
    let t = document.querySelector(".datatables-users"), n = {
        1: {
            title: "Pending",
    ...
    }, a, l = "app-user-view-account.html";
    if (t) {
    ...
    setTimeout( () => {
        [{
            ...
            selector: ".user_role",
            classToAdd: "w-px-200 my-md-0 mt-6 mb-2"
        }, {
            selector: ".user_plan",
            classToAdd: "w-px-200 mb-6 mb-md-0"
