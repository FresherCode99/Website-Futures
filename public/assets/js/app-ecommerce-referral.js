document.addEventListener("DOMContentLoaded", function(e) {
    ...
    let s = document.querySelector(".datatables-referral")
      , n = {
        1: {
            title: "Paid",
    ...
    s && ((t = document.createElement("h5")).classList.add("card-title", "mb-0", "text-md-start", "text-center"),
