    ...
    return function() {
        ...
        var q = {
            slideTo: function(e, t, s, a, i) {
                ...
                if (!h && !a && !i || r.destroyed || r.animating && l.preventInteractionOnTransition)
                    return !1;
        ...
        function _(e) {
            ...
            if ("touchstart" === a.type)
                return void V(t, a, a.targetTouches[0].pageX);
            ...
            s.activeElement && s.activeElement.matches(i.focusableElements) && s.activeElement !== p && ("mouse" === a.pointerType || "mouse" !== a.pointerType && !p.matches(i.focusableElements)) && s.activeElement.blur();
        ...
        function j(e) {
            ...
            if (i.touchReleaseOnEdges && !i.loop)
                if (s.isVertical()) {
                    ...
                    return;
            if (t.activeElement && t.activeElement.matches(a.focusableElements) && t.activeElement !== p.target && "mouse" !== p.pointerType && t.activeElement.blur(),
            ...
            g > 0 ? (b && y && a.allowThresholdMove && a.currentTranslate > (i.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] - ("auto" !== i.slidesPerView && s.slides.length - i.slidesPerView >= 2 ? s.slidesSizesGrid[s.activeIndex + 1] + s.params.spaceBetween : 0) - s.params.spaceBetween : s.minTranslate()) && s.loopFix({
                direction: "prev",
                setTranslate: !0,
                activeSlideIndex: 0
            }),
        ...
        const ee = (e, t) => {
            ...
            a.updateOnWindowResize ? e[c](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", U, !0) : e[c]("observerUpdate", U, !0),
            i[d]("load", e.onLoad, {
                capture: !0
            }))
        }
        ...
        const we = [function(e) {
            ...
            function c(e, t) {
                ...
                u === x && m === S && !e)
                    return s.slidesGrid !== f && T !== g && s.slides.forEach((e => {
        ...
        , function(e) {
            ...
            function P() {
                ...
                i && (r = i.querySelector(oe(t.params.scrollbar.dragClass)),
        ...
        , function(e) {
            ...
            let i, n, l = null, o = (new Date).getTime();
            function d(e) {
                const t = l;
            ...
            function v(e) {
                ...
                if (!t.pagination || !t.pagination.el || a !== t.pagination.el && !t.pagination.el.contains(e.target) || e.target.matches(oe(t.params.pagination.bulletClass))) {
                    if (t.navigation && t.navigation.prevEl && t.navigation.nextEl) {
                        ...
                        C(t.navigation.nextEl).includes(a) && (t.isEnd && !t.params.loop || t.slideNext(),
            ...
            const E = (e, t, s) => {
              ...
              , P = e => {
                ...
                a || r || e.sourceCapabilities && e.sourceCapabilities.firesTouchEvents || (t.isHorizontal() ? t.el.scrollLeft = 0 : t.el.scrollTop = 0,
                requestAnimationFrame(( () => {
                    i || (t.params.loop ? t.slideToLoop(parseInt(s.getAttribute("data-swiper-slide-index")), 0) : t.slideTo(t.slides.indexOf(s), 0),
                    i = !1)
                }
                )))
            }
              ...
              , I = () => {
                ...
                const a = t.wrapperEl
                  , i = e.id || a.getAttribute("id") || `swiper-wrapper-${n = 16,
                void 0 === n && (n = 16),
            ...
            a("paginationUpdate", ( () => {
                t.params.a11y.enabled && function() {
                    ...
                    w() && t.pagination.bullets.forEach((s => {
                        ...
                        h(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, x(s) + 1)))),
                        s.matches(oe(t.params.pagination.bulletActiveClass)) ? s.setAttribute("aria-current", "true") : s.removeAttribute("aria-current")
                    }
                    ))
                }()
            }
