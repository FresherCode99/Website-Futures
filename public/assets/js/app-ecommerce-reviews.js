document.addEventListener("DOMContentLoaded", function(e) {
    ...
    if (n) {
        ...
        var c = new DataTable(n,{
            ...
            columnDefs: [{
              ...
              <div class="d-flex justify-content-start align-items-center customer-name">
                ...
                render: function(e, t, s, a) {
                    var o = s.review
                      , r = s.para;
                    var s = "string" != typeof (s = s.head) || 0 === s.length ? s : s.charAt(0).toUpperCase() + s.slice(1)
                      , n = document.createElement("div")
                      , l = (n.className = "read-only-ratings raty mb-1",
                    n.setAttribute("data-number", "5"),
                    parseInt(window.Helpers.getCssVar("gray-200", !0).slice(1, 3), 16))
                      , i = parseInt(window.Helpers.getCssVar("gray-200", !0).slice(3, 5), 16)
                      , c = parseInt(window.Helpers.getCssVar("gray-200", !0).slice(5, 7), 16);
                    if (n)
                        return new Raty(n,{
                            score: o,
                            readOnly: !0,
                            ...
                            starOff: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' width='16' %3E%3Cpath fill='rgb(" + l + "," + i + "," + c + ")' d='M21.947 9.179a1 1 0 0 0-.868-.676l-5.701-.453l-2.467-5.461a.998.998 0 0 0-1.822-.001L8.622 8.05l-5.701.453a1 1 0 0 0-.619 1.713l4.213 4.107l-1.49 6.452a1 1 0 0 0 1.53 1.057L12 18.202l5.445 3.63a1.001 1.001 0 0 0 1.517-1.106l-1.829-6.4l4.536-4.082c.297-.268.406-.686.278-1.065'/%3E%3C/svg%3E"
                        }).init(),
                        `
              <div>
                ${n.outerHTML}
            ...
            `
                ...
                targets: 5,
                render: function(e, t, s, a) {
                    return '<span class="text-nowrap">' + new Date(s.date).toLocaleDateString("en-US", {
                        month: "short",
                        day: "numeric",
                        year: "numeric"
                    }) + "</span>"
                ...
                render: function(e, t, s, a) {
                    s = s.status;
                    return '<span class="badge ' + i[s].class + '" text-capitalize>' + i[s].title + "</span>"
                }
            }, {
                targets: -1,
                title: "Actions",
                                ...
                                exportOptions: {
                                    ...
                                    format: {
                                        body: function(e, t, s) {
                                            ...
                                            let a = "";
                                            return e.forEach(e => {
                                                e.classList && e.classList.contains("user-name") ? a += e.lastChild.firstChild.textContent : a += e.textContent || e.innerText || ""
                                            }
                                            ),
                                            a
                                        }
            ...
            responsive: {
                details: {
                    ...
                    renderer: function(e, t, s) {
                        var a, o, r, s = s.map(function(e) {
                            return "" !== e.title ? `<tr data-dt-row="${e.rowIndex}" data-dt-column="${e.columnIndex}">
                      <td>${e.title}:</td>
                      <td>${e.data}</td>
                    </tr>` : ""
                        }).join("");
                        return !!s && ((a = document.createElement("div")).classList.add("table-responsive"),
    ...
    document.addEventListener("click", function(e) {
        e.target.classList.contains("delete-record") && (c.row(e.target.closest("tr")).remove().draw(),
    ...
    setTimeout( () => {
        [{
            ...
            selector: ".review_filter .form-select",
            classToAdd: "w-px-100"
        }, {
            selector: ".dt-buttons",
            classToAdd: "mb-0"
            ...
            selector: ".dt-layout-end",
            classToAdd: "d-flex gap-md-0 gap-4"
        }, {
