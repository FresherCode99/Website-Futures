document.addEventListener("DOMContentLoaded", function(e) {
    var t, a, r = document.querySelector(".datatables-order-details");
    r && ((t = document.createElement("h5")).classList.add("card-title", "mb-0"),
