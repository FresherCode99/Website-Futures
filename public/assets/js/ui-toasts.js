document.addEventListener("DOMContentLoaded", function(e) {
  let t = document.querySelector(".toast-ex"), s = document.querySelector(".toast-placement-ex"), n = document.querySelector("#showToastAnimation"), o = document.querySelector("#showToastPlacement"), i, c, a, l, r;
  function d(e) {
      e && null !== e._element && (s && (s.classList.remove(i),
  ...
  class m extends Notyf {
      _renderNotification(e) {
          ...
          return e.message && (t.message.innerHTML = e.message),
          t
      }
  }
  let p = new m({
