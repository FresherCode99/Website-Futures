                    ...
                    <li>
                        <a class="dropdown-item" href="{{route('account-setting')}}">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar avatar-online">
                                        <img src="{{ $user->avatar ? asset('../../storage/'.$user->avatar) : asset('../../storage/avatars/1.png') }}" alt
                                            class="w-px-40 h-auto rounded-circle" />
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <h6 class="mb-0" style="text-transform: uppercase;">{{ Auth::User()->fullname  }}</h6>
                                    <small class="text-body-secondary " style=" text-transform: capitalize;">{{ Auth::User()->role }}</small>
                                </div>
                            </div>
                        </a>
                    </li>
